...
# %% combine
speech_corp_df[['mat_filename','corpus_type','10fold_labels']].to_csv('train_test_split/speech_10folds_speakerGroupFold.csv' ,index=False)
music_corp_df[['mat_filename','corpus_type','10fold_labels']].to_csv('train_test_split/music_10folds_speakerGroupFold.csv' ,index=False)
df_SONYC[['mat_filename','corpus_type','10fold_labels']].to_csv('train_test_split/env_10folds_speakerGroupFold.csv' ,index=False)
