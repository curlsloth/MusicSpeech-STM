...
metaData_name_list = [
    'metaTables/metaData_fma_large.csv',
    'metaTables/metaData_ismir04_genre.csv',
    'metaTables/metaData_MagnaTagATune.csv',
    'metaTables/metaData_MTG-Jamendo.csv']
for metaData_name in metaData_name_list:
    t_start = time.time()
    print(metaData_name)
    df = pd.read_csv(metaData_name,index_col=0)   
    corpus_name = metaData_name[20:-4]
    np.save('STM_output/corpSTMnpy_music_new/'+corpus_name+'_STMall.npy', stack_STM(df))
