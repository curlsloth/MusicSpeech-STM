...
Phase 2.1: Attention-Enhanced Transfer Learning with Discriminative LR

Key Innovations (V2.1 over V2.0):
...
4. Stronger Regularization: Head dropout 0.4, weight decay 5e-4, mixup α=0.4
...
class PretrainedSTMResNet18(nn.Module):
    ...
    3. Head Dropout: Increased to 0.4 for stronger regularization
...
# ============================================================================
# Trainer (V2.1 with Discriminative Learning Rates)
# ============================================================================

class Trainer:
    """
    Trainer with V2.1 enhancements: Discriminative LR + V2 dynamics
    """
    ...
    def train_epoch(self, epoch, total_epochs, use_drw=False, use_mixup=True):
        ...
        for batch_idx, (data, target) in enumerate(self.train_loader):
            ...
            # Apply Mixup with 30% probability (stronger alpha=0.4 in V2.1)
