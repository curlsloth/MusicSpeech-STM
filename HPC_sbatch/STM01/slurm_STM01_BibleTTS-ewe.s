...
#SBATCH --job-name=BibleTTS-ewe
#SBATCH --nodes=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=8GB
#SBATCH --time=00:40:00
#SBATCH --output=HPC_slurm/STM01/BibleTTS-ewe/slurm_%A_%a.out
...
# Run this: sbatch --array=0-224 HPC_sbatch/STM01/slurm_STM01_BibleTTS-ewe.s
