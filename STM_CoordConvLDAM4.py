...
1. Coordinate Attention (CA) in early layers (position-aware)
2. Squeeze-and-Excitation (SE) in late layers (channel selection)
3. Multi-scale feature fusion (combine layer3 + layer4)
4. Keep V2 training dynamics (proven regularization strategies)
"""
...
if __name__ == "__main__":
    ...
    # Create model
    print("\n" + "="*60)
    print("Creating CoordConv-ResNet18 with Attention (V4)...")
    print("="*60)
